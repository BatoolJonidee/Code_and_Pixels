        ...
        <div class="modal fade" id="categoryAddModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <form method="post" action="{{ route('categories.store') }}" style=" width:100%;text-align: center" enctype="multipart/form-data">
                        <div class="modal-body">
                            @csrf
                            <label class="col-3">Name:</label>
                            <input class="col-5" class="input-class" type="text" name="name" placeholder="Category Name" required><br>
                            @error('name')
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body" style="text-align: center">
                                            <form method="post" action="{{ route('categories.update', $category->id) }}"
                                                ...
                                                {{--  name edit --}}
                                                <label class="col-3">Name:</label>
                                                <input  class="col-5" type="text" name="name" value="{{ $category->name }}" required><br>
