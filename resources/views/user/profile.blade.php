    ...
    <div id="containerProfile" style="display: flex; justify-content: space-evenly; width:100%;">
        ...
        <div id="photoDivProfile"
            ...
            <div id="appointmentBtn"
                style="text-align: center ; margin-top:5% ; background-color: #076595; color:white ;cursor: pointer; border-radius: 10px;">
                <h5>
                    Appointments
                </h5>
            </div>
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <span><input id='fnameEditInput' type="text" value="{{ $user->fname }}"
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <input type="hidden" value="{{ $user->id }}" name="id">
                                <span>Last Name</span>
                                <span><input id="lnameEditInput" type="text" value="{{ $user->lname }}"
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <input type="hidden" value="{{ $user->id }}" name="id">
                                <span>Email</span>
                                <span><input id="emailEditInput" type="email" value="{{ $user->email }}"
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <input type="hidden" value="{{ $user->id }}" name="id">
                                <span>Phone</span>
                                <span><input id="phoneEditInput" type="number" value="0{{ $user->phone }}"
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <span>Address</span>
                                <span>
                                    <textarea cols="40" rows="1" name='address' class="editProfileInput" required>{{ $user->address }}</textarea>
                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-secondary"
                                    data-bs-dismiss="modal">Close</button>
        ...
        <div id="appointmentDiv"
            style="display:none;margin-top: 5%;border:1px solid gray;box-shadow: 5px 5px 10px gray; border-radius:10px ;width:70%;margin-bottom: 5%;padding:1%">
            <h3>Sessions</h3>
            <hr>
            <div class="table-responsive table-data">
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="submit" class="btn btn-outline-danger" value="Delete"
                                        ...
                                        data-bs-target="#reservationDeleteModal{{ $reservation->id }}">
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
                ...
                @foreach ($reservations as $reservation)
                    <div class="modal fade" id="reservationDeleteModal{{ $reservation->id }}" tabindex="-1"
                        ...
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                ...
                                @if ($reservation->status == 'pending')
                                    ...
                                    <div class="modal-footer">
                                        <form method="post"
                                            action="{{ url('delete-session-userSide', $reservation->id) }}">
                                            @csrf
                                            @method('DELETE')
                                ...
                                @elseif ($reservation->status == 'confirmed')
                                    <div class="modal-body">
                                        You can't delete this session because this session is <span
                                            style="color: red; font-weight: bold">Confirmed</span>
                                    </div>
                                    <div class="modal-footer">
                                ...
                                @else
                                <div class="modal-body">
                                    This session has been <span
                                        style="color: red; font-weight: bold">Canceled</span>
                                </div>
                                <div class="modal-footer">
                                    <button type="button" class="btn "
                                        style="background-color: #076595; color:white"
