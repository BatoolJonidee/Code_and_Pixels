@if (session()->has('user_id') != null && session('is_admin') == 1)
    ...
    <div id="containerProfilePhotographer">
        ...
        <div id="photoDivProfilePhotographer">
            <div>
                <img id="profilePicPhotographer" src="{{ asset('storage/' . $photographer->photo) }}"
                    alt="Photographer Profile Picture" data-bs-toggle="modal" data-bs-target="#pictureEditModal">
            </div>
        ...
        <div id="settingDivPhotographer">
            ...
            <div id="fname-showPhotographer">
                ...
                <div>
                    <button class="btn" type="button" data-bs-toggle="modal" data-bs-target="#fnameEditModal"
                ...
                <div class="modal fade" id="fnameEditModal" tabindex="-1" aria-labelledby="exampleModalLabel"
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                                <button type="submit" class="btn " id="save-fname-Button-Photographer">Save
                                    changes</button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                <button type="button" class="btn btn-secondary"
                                    data-bs-dismiss="modal">Close</button>
                                <button type="submit" class="btn" id="save-email-Button-Photographer">Save
                                    changes</button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                <button type="button" class="btn btn-secondary"
                                    data-bs-dismiss="modal">Close</button>
                                <button type="submit" class="btn" id="save-password-Button-Photographer">Save
                                    changes</button>
                            </div>
                        </div>
                    </div>
            ...
            <div id="description-showPhotographer">
                ...
                <div>
                    <button type="button" class="btn" data-bs-toggle="modal"
                        data-bs-target="#descriptionEditModal"
                        style="background-color: #076595; color:white; cursor: pointer;">
                        <i class="fa-solid fa-pen-to-square"></i>
                    </button>
                </div>
