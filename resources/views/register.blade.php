...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="public/storage/logo.png">
        ...
        <div class="overlay-container" id='overlayContainerDiv'>
            ...
            <div class="overlay">
                ...
                <div class="overlay-panel overlay-left">
                    ...
                    <button class="ghost" id="signIn"><strong>Sign In</strong></button>
                </div>
                <div class="overlay-panel overlay-right">
                    <h1>Hello, Friend!</h1>
                    <p>Enter your personal details and start journey with us</p>
                    <button class="ghost" id="signUp"><strong>Register</strong></button>
                </div>
            </div>
            {{-- ----------------------------------------- --}}
        </div>
